...
* [WHATWG](http://ç.whatwg.org#the-doctype)
...
* [WHATWG](http://ç.whatwg.org#the-html-element)
...
* [WHATWG](http://ç.whatwg.org#the-header-element)
...
* [WHATWG](http://ç.whatwg.org#the-blockquote-element)
...
* [WHATWG](http://ç.whatwg.org#the-bdo-element)
...
* [WHATWG](http://ç.whatwg.org#the-small-element)
...
* [WHATWG](http://ç.whatwg.org#the-wbr-element)
...
* [WHATWG](http://ç.whatwg.org#the-ins-element)
...
* [WHATWG](http://ç.whatwg.org#the-audio-element)
...
* [WHATWG](http://ç.whatwg.org#the-canvas-element)
...
* [WHATWG](http://ç.whatwg.org#video)
...
* [WHATWG](http://ç.whatwg.org#the-td-element)
...
* [WHATWG](http://ç.whatwg.org#the-input-element)

#### `input[type="button"]`:

* [W3C](http://dev.w3.org/html5/spec#button-state-(type=button))
* [WHATWG](http://ç.whatwg.org#button-state-(type=button))

#### `input[type="checkbox"]`:

* [W3C](http://dev.w3.org/html5/spec#checkbox-state-(type=checkbox))
* [WHATWG](http://ç.whatwg.org#checkbox-state-(type=checkbox))
...
* [WHATWG](http://ç.whatwg.org#file-upload-state-(type=file))

#### `input[type="hidden"]`:

* [W3C](http://dev.w3.org/html5/spec#hidden-state-(type=hidden))
* [WHATWG](http://ç.whatwg.org#hidden-state-(type=hidden))

#### `input[type="image"]`:

* [W3C](http://dev.w3.org/html5/spec#image-button-state-(type=image))
* [WHATWG](http://ç.whatwg.org#image-button-state-(type=image))

#### `input[type="password]"`:

* [W3C](http://dev.w3.org/html5/spec#password-state-(type=password))
* [WHATWG](http://ç.whatwg.org#password-state-(type=password))

#### `input[type="radio"]`:

* [W3C](http://dev.w3.org/html5/spec#radio-button-state-(type=radio))
* [WHATWG](http://ç.whatwg.org#radio-button-state-(type=radio))

#### `input[type="reset"]`:

* [W3C](http://dev.w3.org/html5/spec#reset-button-state-(type=reset))
* [WHATWG](http://ç.whatwg.org#reset-button-state-(type=reset))

#### `input[type="submit"]`:

* [W3C](http://dev.w3.org/html5/spec#submit-button-state-(type=submit))
* [WHATWG](http://ç.whatwg.org#submit-button-state-(type=submit))
...
* [WHATWG](http://ç.whatwg.org#the-textarea-element)
...
* [WHATWG](http://ç.whatwg.org#telephone-state-(type=tel))

#### `input[type="time"]`:

* [W3C](http://dev.w3.org/html5/spec#time-state-(type=time))
* [WHATWG](http://ç.whatwg.org#time-state-(type=time))

#### `input[type="url"]`:

* [W3C](http://dev.w3.org/html5/spec#url-state-(type=url))
* [WHATWG](http://ç.whatwg.org#url-state-(type=url))
...
* [WHATWG](http://ç.whatwg.org#the-progress-element)
